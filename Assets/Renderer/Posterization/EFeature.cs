...
public class EFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public CustomRenderPass(RenderTexture rt, RenderTexture rt2, Material material, Material maskMat, Material nonMat,
    ...
    {
        m_ScriptablePass =
            new CustomRenderPass(settings.rt, settings.rt2, settings.material, settings.maskMat, settings.nonMat, settings.layerMask);
